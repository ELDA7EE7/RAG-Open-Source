...
def generate_multi_query(query, context, model="mistral-openorca"):
    prompt = """
    ...
    response = ollama.chat(
        model=model,   # e.g., "mistral", "llama3", "qwen2", etc.
        messages=messages
    )
    ...
    # Split response into lines (same behavior as your original function)
